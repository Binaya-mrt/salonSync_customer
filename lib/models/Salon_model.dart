...
class Salon {
  ...
  factory Salon.fromMap(Map<String, dynamic> data) {
    return Salon(
        ...
        catalouges: data['catalogues']
            .map((p) => Catalouge.fromJson(p))
            .toList()
            .cast<Catalouge>(),
...
// //
  factory Salon.fromJson(Map<String, dynamic> json) => Salon(
      salon_address: json['salon_address'],
      catalouges: json['catalogue'],
      saon_end_time: json['salon_ratingsalon_end_time'],
      salon_name: json['salon_name'],
      services: json['Services'].map((p) => (p)).toList().cast<String>(),
      salon_start_time: json['salon_start_time'],
      all_available_slots: json['all_available_slots'],
      salon_uid: json['uid'],
      salon_email: json['salon_email'],
      salon_image: json['salon_image'],
      salon_phone: json['salon_phone']);
  ...
  factory Salon.fromSnapshot(DocumentSnapshot<Map<String, dynamic>> snap) {
    ...
    return Salon(
        ...
        catalouges: snapshot?['catalogue']
            .map((p) => Catalouge.fromJson(p))
            .toList()
            .cast<Catalouge>(),
        saon_end_time: snapshot?['salon_ratingsalon_end_time'],
        salon_name: snapshot?['salon_name'],
        services: snapshot?['Services'].map((p) => (p)).toList().cast<String>(),
